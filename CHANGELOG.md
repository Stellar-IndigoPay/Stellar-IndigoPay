...
### Added
- **extension/security:** add a restrictive MV3 content security policy to Chrome and Firefox manifests, with validation coverage for privileged extension pages.
