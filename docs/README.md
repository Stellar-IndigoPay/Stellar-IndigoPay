...
| **[CI / CD pipeline](../.github/workflows/)** | Per-app workflows (`backend.yml`, `frontend.yml`, `extension.yml`, `mobile.yml`, `contracts.yml`), release, and secret-scanning. |
...
*If you find a missing link, broken example, or unclear section, please open
