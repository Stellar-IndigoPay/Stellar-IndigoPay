...
function renderPreview(overrides: Partial<typeof simulation> = {}) {
...
describe("TransactionPreview", () => {
  ...
  it("announces the summary via an aria-live region", () => {
    renderPreview();

    const liveRegion = screen.getByTestId("preview-live-region");
